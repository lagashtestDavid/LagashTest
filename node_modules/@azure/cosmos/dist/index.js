(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('.'), require('big-integer'), require('int64-buffer'), require('os'), require('tslib'), require('util'), require('url'), require('assert'), require('binary-search-bounds'), require('semaphore'), require('priorityqueuejs'), require('create-hmac'), require('querystring'), require('https'), require('tunnel')) :
    typeof define === 'function' && define.amd ? define(['exports', '.', 'big-integer', 'int64-buffer', 'os', 'tslib', 'util', 'url', 'assert', 'binary-search-bounds', 'semaphore', 'priorityqueuejs', 'create-hmac', 'querystring', 'https', 'tunnel'], factory) :
    (factory((global.CosmosClient = {}),global._,global.BigInt,global.int64Buffer,global.os,global.tslib_1,global.util,global.url,global.assert,global.bs,global.semaphore,global.PriorityQueue,global.createHmac,global.querystring,global.https,global.tunnel));
}(this, (function (exports,_,BigInt,int64Buffer,os,tslib_1,util,url,assert,bs,semaphore,PriorityQueue,createHmac,querystring,https,tunnel) { 'use strict';
    ...
    /** @hidden */
    const Regexes = _.Constants.RegularExpressions;
    /** @hidden */
    class Helper {
        ...
        static isReadRequest(request) {
            return (request.operationType === _.Constants.OperationTypes.Read ||
                request.operationType === _.Constants.OperationTypes.Query);
        }
        static sleep(time) {
        ...
        static trimSlashes(source) {
            return source
                .replace(_.Constants.RegularExpressions.TrimLeftSlashes, "")
                .replace(_.Constants.RegularExpressions.TrimRightSlashes, "");
        }
        static getHexaDigit() {
        ...
        static setIsUpsertHeader(headers) {
            ...
            headers[_.Constants.HttpHeaders.IsUpsert] = true;
        }
    ...
    /** @hidden */
    const EMPTY = "0"; // TODO: This is kinda hacky
    /** @hidden */
    class ResourceId {
        constructor() {
            this.offer = EMPTY;
        ...
        getValue() {
            ...
            if (this.storedProcedure !== EMPTY) {
                big = new int64Buffer.Int64BE(this.storedProcedure);
                big.toBuffer().copy(buffer, 8, 0, 8);
            }
            else if (this.trigger !== EMPTY) {
                big = new int64Buffer.Int64BE(this.trigger);
                big.toBuffer().copy(buffer, 8, 0, 8);
            }
            else if (this.userDefinedFunction !== EMPTY) {
                big = new int64Buffer.Int64BE(this.userDefinedFunction);
                big.toBuffer().copy(buffer, 8, 0, 8);
            }
            else if (this.conflict !== EMPTY) {
                big = new int64Buffer.Int64BE(this.conflict);
                big.toBuffer().copy(buffer, 8, 0, 8);
            }
            else if (this.document !== EMPTY) {
                big = new int64Buffer.Int64BE(this.document);
                big.toBuffer().copy(buffer, 8, 0, 8);
            }
            else if (this.permission !== EMPTY) {
                big = new int64Buffer.Int64BE(this.permission);
                big.toBuffer().copy(buffer, 8, 0, 8);
            }
            else if (this.partitionKeyRange !== EMPTY) {
                big = new int64Buffer.Int64BE(this.partitionKeyRange);
                big.toBuffer().copy(buffer, 8, 0, 8);
            }
            if (this.attachment !== EMPTY) {
    ...
    class RetryUtility {
        ...
        static execute(globalEndpointManager, body, createRequestObjectFunc, connectionPolicy, requestOptions, request) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const endpointDiscoveryRetryPolicy = new _.EndpointDiscoveryRetryPolicy(globalEndpointManager, r);
                const resourceThrottleRetryPolicy = new _.ResourceThrottleRetryPolicy(connectionPolicy.RetryOptions.MaxRetryAttemptCount, connectionPolicy.RetryOptions.FixedRetryIntervalInMilliseconds, connectionPolicy.RetryOptions.MaxWaitTimeInSeconds);
                const sessionReadRetryPolicy = new _.SessionRetryPolicy(globalEndpointManager, r, connectionPolicy);
            ...
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    if (!results) {
                        ...
                        yield Helper.sleep(retryPolicy.retryAfterInMilliseconds);
    ...
    var index = /*#__PURE__*/Object.freeze({
        get ConnectionMode () { return exports.ConnectionMode; },
        ConnectionPolicy: ConnectionPolicy$$1,
        get ConsistencyLevel () { return exports.ConsistencyLevel; },
        DatabaseAccount: DatabaseAccount,
        get DataType () { return exports.DataType; },
        get IndexingMode () { return exports.IndexingMode; },
        get IndexKind () { return exports.IndexKind; },
        get MediaReadMode () { return exports.MediaReadMode; },
        get PartitionKind () { return exports.PartitionKind; },
        get PermissionMode () { return exports.PermissionMode; },
        get QueryCompatibilityMode () { return exports.QueryCompatibilityMode; },
        get TriggerOperation () { return exports.TriggerOperation; },
        get TriggerType () { return exports.TriggerType; },
        get UserDefinedFunctionType () { return exports.UserDefinedFunctionType; }
    });
    ...
    class SmartRoutingMapProvider {
        constructor(clientContext) {
            this.partitionKeyRangeCache = new _.PartitionKeyRangeCache(clientContext);
        }
        ...
        static _subtractRange(r, partitionKeyRange) {
            ...
            return new _.QueryRange(left, r.max, leftInclusive, r.isMaxInclusive);
        }
        /**
        ...
        getOverlappingRanges(collectionLink, sortedRanges) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                while (true) {
                    ...
                    const lastKnownTargetRange = _.QueryRange.parsePartitionKeyRange(partitionKeyRanges[partitionKeyRanges.length - 1]);
    ...
    /** @hidden */
    const https$1 = isBrowser && false ? require("stream-http") : require("https");
    ...
    function createRequestObject(connectionPolicy, requestOptions, body) {
        return new Promise((resolve, reject) => {
            ...
            const httpsRequest = https$1.request(requestOptions, (response) => {
        ...
        headers) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (buffer) {
                    ...
                    return RetryUtility.execute(globalEndpointManager, { buffer, stream: null }, this.createRequestObjectStub, connectionPolicy, requestOptions, request);
                }
                else if (stream) {
                    return RetryUtility.execute(globalEndpointManager, { buffer: null, stream }, this.createRequestObjectStub, connectionPolicy, requestOptions, request);
                }
                else {
                    return RetryUtility.execute(globalEndpointManager, { buffer: null, stream: null }, this.createRequestObjectStub, connectionPolicy, requestOptions, request);
                }
            });
        }
        /** @ignore */
    ...
    class SessionContainer {
        ...
        getContainerName(request, headers) {
            ...
            return Helper.getContainerLink(ownerFullName);
        }
    }
    ...
    class ClientContext {
            ...
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const request = {
                        // TODO: any
                        path,
                        operationType: _.Constants.OperationTypes.Read,
                        client: this,
                    ...
                    this.captureSessionToken(undefined, path, _.Constants.OperationTypes.Read, response.headers);
                    return response;
                }
                catch (err) {
                    this.captureSessionToken(err, path, _.Constants.OperationTypes.Upsert, err.headers);
                    throw err;
                }
            });
        }
        ...
        query, options, partitionKeyRangeId) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const request = {
                    // TODO: any request
                    path,
                    operationType: _.Constants.OperationTypes.Query,
                    client: this,
                    endpointOverride: null
                };
                const endpoint = yield this.globalEndpointManager.resolveServiceEndpoint(request);
                ...
                if (query === undefined) {
                    ...
                    this.captureSessionToken(undefined, path, _.Constants.OperationTypes.Query, resHeaders);
                    return this.processQueryFeedResponse({ result, headers: resHeaders }, !!query, resultFn);
                }
                else {
                    initialHeaders[_.Constants.HttpHeaders.IsQuery] = "true";
                    switch (this.cosmosClientOptions.queryCompatibilityMode) {
                        case exports.QueryCompatibilityMode.SqlQuery:
                            initialHeaders[_.Constants.HttpHeaders.ContentType] = _.Constants.MediaTypes.SQL;
                            break;
                        ...
                        default:
                            ...
                            initialHeaders[_.Constants.HttpHeaders.ContentType] = _.Constants.MediaTypes.QueryJson;
                            break;
                    }
        ...
        queryPartitionKeyRanges(collectionLink, query, options) {
            ...
            return new _.QueryIterator(this, query, options, cb);
        }
        delete(path, type, id, initialHeaders, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const request = {
                        client: this,
                        operationType: _.Constants.OperationTypes.Delete,
                        path,
                        resourceType: type
                    };
                    this.applySessionToken(path, reqHeaders);
                    ...
                    if (Helper.parseLink(path).type !== "colls") {
                        this.captureSessionToken(undefined, path, _.Constants.OperationTypes.Delete, response.headers);
                    }
                    else {
        ...
        create(body, path, type, id, initialHeaders, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const request = {
                        client: this,
                        operationType: _.Constants.OperationTypes.Create,
                        path,
                        resourceType: type
                    };
                    ...
                    this.captureSessionToken(undefined, path, _.Constants.OperationTypes.Create, response.headers);
                    return response;
                }
                catch (err) {
                    this.captureSessionToken(err, path, _.Constants.OperationTypes.Upsert, err.headers);
        ...
        applySessionToken(path, reqHeaders) {
            ...
            if (reqHeaders && reqHeaders[_.Constants.HttpHeaders.SessionToken]) {
                return;
            }
            const sessionConsistency = reqHeaders[_.Constants.HttpHeaders.ConsistencyLevel];
            ...
            if (request.resourceAddress) {
                ...
                if (sessionToken) {
                    reqHeaders[_.Constants.HttpHeaders.SessionToken] = sessionToken;
                }
            }
        }
        replace(resource, path, type, id, initialHeaders, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const request = {
                        client: this,
                        operationType: _.Constants.OperationTypes.Replace,
                        path,
                        resourceType: type
                    };
                    this.applySessionToken(path, reqHeaders);
                    ...
                    this.captureSessionToken(undefined, path, _.Constants.OperationTypes.Replace, response.headers);
                    return response;
                }
                catch (err) {
                    this.captureSessionToken(err, path, _.Constants.OperationTypes.Upsert, err.headers);
        ...
        upsert(body, path, type, id, initialHeaders, options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const request = {
                        client: this,
                        operationType: _.Constants.OperationTypes.Upsert,
                        path,
                        resourceType: type
                    };
                    ...
                    const endpoint = yield this.globalEndpointManager.resolveServiceEndpoint(request);
                    const response = yield this.requestHandler.post(endpoint, request, body, requestHeaders);
                    this.captureSessionToken(undefined, path, _.Constants.OperationTypes.Upsert, response.headers);
                    return response;
                }
                catch (err) {
                    this.captureSessionToken(err, path, _.Constants.OperationTypes.Upsert, err.headers);
        ...
        options) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const request = {
                    client: this,
                    operationType: _.Constants.OperationTypes.Execute,
                    path,
                    resourceType: "sprocs"
                };
        ...
        isMasterResource(resourceType) {
            if (resourceType === _.Constants.Path.OffersPathSegment ||
                resourceType === _.Constants.Path.DatabasesPathSegment ||
                resourceType === _.Constants.Path.UsersPathSegment ||
                resourceType === _.Constants.Path.PermissionsPathSegment ||
                resourceType === _.Constants.Path.TopologyPathSegment ||
                resourceType === _.Constants.Path.DatabaseAccountPathSegment ||
                resourceType === _.Constants.Path.PartitionKeyRangesPathSegment ||
                resourceType === _.Constants.Path.CollectionsPathSegment) {
                return true;
            }
            return false;
        }
            ...
            process.nextTick(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    do {
                        ...
                        yield Helper.sleep(this.backgroundRefreshTimeIntervalInMS);
                    } while (shouldRefresh);
                }
                catch (err) {
                    /* swallow error */
    ...
    exports.DocumentBase = index;
    exports.AzureDocuments = index;
